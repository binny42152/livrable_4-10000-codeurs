# livrable_4-10000-codeurs
livrable_4 du programme de formation 10000 codeurs
	************************************
*****  	Description de l'application:   	*****
	************************************
ProducersSave2 est une application qui permet d'enregistrer puis d'afficher 
les informations sur les producteurs repertoriés dans les différentes zones agroécologiques nécessaires au recenssement des acteurs du monde rural. 
...
1) 	A l'aide de votre interpretteur de commande (cmd.exe),
	...
	le fichier compressé "ProducersSave.jar"
	('cd [chemin]/[dossier cible]').

2)	Entrer la commande 'java -jar ProducersSave.jar'.
